...
const statusColors: Record<string, string> = {
  ...
  draft: "bg-white/[0.06] text-gray-400 border-white/12",
};
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white/[0.06] border border-white/12 rounded-xl text-sm text-white placeholder:text-gray-300 focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl text-xs font-medium capitalize transition-all ${
                filter === f
                  ...
                  : "bg-white/[0.06] border border-white/12 text-gray-300 hover:text-gray-300"
              }`}
            >
              {f}
            </button>
      ...
      <div className="grid gap-4">
        {filtered.map((project) => {
          ...
          return (
            <div
              key={project.id}
              className="bg-[#12121a] rounded-xl p-5 border border-white/12 hover:border-violet-500/20 hover:shadow-md hover:shadow-blue-500/5 transition-all group"
            >
