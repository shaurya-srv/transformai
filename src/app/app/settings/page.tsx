          ...
          {activeSection === "profile" && (
            <div className="space-y-6 animate-fade-in-up">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-surface border border-white/10 rounded-xl text-sm text-white focus:outline-none focus:border-violet-500/50 transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-text-secondary mb-1.5">
              ...
              <button
                onClick={handleSave}
                disabled={isSaving}
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-violet-600 hover:bg-violet-500 text-white rounded-xl text-sm font-semibold transition-all shadow-lg shadow-violet-500/20 disabled:opacity-50"
              >
                {isSaving ? (
            ...
            <div className="space-y-6 animate-fade-in-up">
              <div className="glass rounded-2xl p-6">
                ...
                <div className="space-y-4 max-w-md">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2.5 bg-surface border border-white/10 rounded-xl text-sm text-white focus:outline-none focus:border-violet-500/50 transition-all pr-10"
                      />
                      <button
                        type="button"
                  ...
                  <button
                    onClick={handleSave}
                    className="px-5 py-2.5 bg-violet-600 hover:bg-violet-500 text-white rounded-xl text-sm font-semibold transition-all"
                  >
                    Update Password
                  </button>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5">
                    <div>
                      ...
                      <p className="text-[10px] text-text-tertiary">Chrome · Just now</p>
                    </div>
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`relative w-10 h-6 rounded-full transition-colors ${
                          item.checked ? "bg-violet-600" : "bg-white/10"
                        }`}
                      >
                        <div
