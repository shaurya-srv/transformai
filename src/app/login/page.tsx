    ...
    <div className="min-h-screen bg-slate-50 grid-bg flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative z-10">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-gray-300 bg-white text-blue-600 focus:ring-blue-500/25"
              />
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full mt-3 py-3 bg-blue-50 border border-blue-100 hover:bg-blue-100 text-blue-700 rounded-xl text-sm font-semibold transition-all flex items-center justify-center gap-2"
        >
          ⚡ Try Demo Mode
        </button>
